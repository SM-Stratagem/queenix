...
const TICKETS: Ticket[] = [
  {
    ...
    memberInitials: 'PS',
    subject: 'Cannot book HIIT 45 — slot shows full',
    status: 'open',
    priority: 'high',
    category: 'class',
    timeAgo: '4 min ago',
  },
  {
    ...
    memberInitials: 'JW',
    subject: 'Locker #87 lock malfunction',
    status: 'in_progress',
    priority: 'medium',
    category: 'general',
    timeAgo: '12 min ago',
  },
  {
    ...
    memberInitials: 'FZ',
    subject: 'Refund for cancelled reformer class',
    status: 'waiting',
    priority: 'medium',
    category: 'billing',
    timeAgo: '28 min ago',
  },
  {
    ...
    memberInitials: 'MA',
    subject: 'Door access denied despite active plan',
    status: 'open',
    priority: 'critical',
    category: 'access',
    timeAgo: '1 hour ago',
  },
  {
    id: 't5',
    ticketCode: 'QNX-4917',
    memberName: 'Noura Al-Marri',
    memberInitials: 'NM',
    subject: 'Guest pass — bring spouse tomorrow',
    status: 'in_progress',
    priority: 'low',
    category: 'general',
    timeAgo: '2 hours ago',
  },
  {
    ...
    memberInitials: 'CM',
    subject: 'Update billing card on file',
    status: 'open',
    priority: 'low',
    category: 'billing',
    timeAgo: '3 hours ago',
